...
/**
 * clase main donde vamos a probar las el resto de clases del paquete
 * @author ALUMNO
 * @version 1.0
 */
...
teclado.close();
	...
	/**
	 * funcion mostrar menu y comprueba que el numero introducido es correcto
	 * @return nos devuelve si hemos escrito un valor correcto
	 */
